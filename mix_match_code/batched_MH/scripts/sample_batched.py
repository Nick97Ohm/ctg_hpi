...
if args.degenerate:
    ...
    folder_name = "disc_{}_data_{}_max_iter_{}_date_{}".format(args.disc_name, args.data_name, max_iter, temperature,
                                                               args.shuffle_positions, args.block, args.alpha,
                                                               args.beta, args.delta, args.gamma, args.theta, dt_string)
...
with open(f"{dirname}/samples.txt", "w") as f, open(f"{dirname}/opt_samples.txt", "w") as optimal_f, open(
        ...
        f"{dirname}/metadata.txt", "w") as f_meta, open(f"{data_dir}", "r") as data_file, open(f"{attr_dir}",
                                                                                               "r") as attr_file:
